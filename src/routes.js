...
const KonfigurasiAplikasi = React.lazy(() => import('./views/konfigurasi/konfig'));
...
const JurnalBuku = React.lazy(() => import('./views/master/jurnal/index'));
const Reminder = React.lazy(() => import('./views/master/reminder/index'));
...
const routes = [
  ...
  { path: '/master/jurnal/:method', name: 'Kenaikan Pangkat', component: JurnalBuku },
  { path: '/master/reminder', name: 'Reminder', component: Reminder },


  { path: '/konfigurasi/user', name: 'Konfigurasi Pegawai', component: KonfigurasiUser },
  { path: '/konfigurasi/aplikasi', name: 'Konfigurasi Aplikasi', component: KonfigurasiAplikasi },
